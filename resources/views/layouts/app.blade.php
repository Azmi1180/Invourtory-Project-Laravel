            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class=" ml-4 nav-item">
                            <a href="/inventory/index">Inventory</a>
                        </li>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                ...
                <div class="sidebar-brand-text mx-3">INVOURTORY </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/barang/index">Manage Items</a>
                    </div>
                </div> --}}
            ...
            <li class="nav-item">
                ...
                {{-- <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Global Pages:</h6>
                        <a class="collapse-item" href="/barang/index">Daftar Barang</a>
                        <a class="collapse-item" href="/inventory/index">Inventory</a>
    ...
    {{-- <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; INVOURTORY 2022</span>
            </div>
        </div>
    </footer> --}}
    <!-- End of Footer -->
